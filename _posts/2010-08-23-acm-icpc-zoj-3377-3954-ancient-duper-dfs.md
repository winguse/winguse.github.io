...
<pre>
<span style="color: #008000">x</span>e<span style="color: #ff0000">e</span>x
xxex
xe<span style="color: #008000">x</span>x
xxxx
</pre>
...
题目很慷慨，8秒时间，我本来不想做的，但看到这个数值，以及最大数据量5x5，就开始动手了，想不到的是，我深搜没学好，对于这个题目，过早的认为找到中间答案就是最终答案，状态还原懒了，导致Wrong Answer。
