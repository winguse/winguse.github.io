...
For x and y to have integer solutions, ${tex`\frac{8n - 2b - k}{2}`} must be a multiple of 2.
...
One solution is: ${tex`x_0 = -5, y_0 = 7`}. Since the original equation can be written as ${tex` 36(x_0 + 13q) + 26(y_0 - 18q) = 2 `}, where q is an integer, the general solution is
${tex` \begin{cases} \begin{aligned}x & = -5 + 13q \\ y & = 7 - 18q\end{aligned}\end{cases}`}

This general solution is for ${tex` 36x + 26y = \gcd(36, 26) = 2 `}, but for what we need, it should be ${tex` \begin{cases} \begin{aligned} x & = -5 \times \frac{8n - 2b - k}{2} + 13q \\ y & = 7 \times \frac{8n - 2b - k}{2} - 18q\end{aligned}\end{cases}`}
